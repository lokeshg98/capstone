    ...
    return variant === 'sidebar'
      ...
      : (
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          AI usage stats could not be loaded. Refresh the page after the backend has restarted.
          If this persists, check the browser network tab for <code className="text-xs">GET /api/me/llm-usage</code>.
        </div>
        );
  }
