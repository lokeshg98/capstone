    ...
    <div className="flex-1 flex flex-col bg-white overflow-hidden">
      <div className="shrink-0 h-14 px-5 flex items-center gap-3 border-b border-gray-200">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">FAQ RAG, memory, channels, web search (admins), moderation tools</p>
        </div>
      </div>
        ...
        {history.length === 0 && (
          <div className="text-center text-gray-400 pt-12">
            ...
            <p className="text-xs mt-1 max-w-md mx-auto">
              Answers use your FAQ documents, channel history when the bot searches, long-term memory from past
              Ask Bot turns, and optional web search. Scheduling proposals always need your confirmation.
            </p>
